...
#
# Exemple:
# python classifieur_lineaire.py 3 280 280 0.001 1 1
#
#################################################
...
def main():
    ...
    [x_train, t_train, x_test, t_test] = gestionnaire_donnees.generer_donnees() #t_train/test = 1 ou 0
    ...
    predictions_entrainement = np.array([classifieur.prediction(x) for x in x_train]) #279
