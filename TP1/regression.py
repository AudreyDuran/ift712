...
def warning(erreur_test, erreur_apprentissage, bruit):
    ...
    # AJOUTER CODE ICI
    # sur aprentissage
    # erreur_test > erreur_apprentissage + bruit: #erreur apprentissage tres faibles et test elevees
    if erreur_apprentissage < bruit and erreur_test > bruit:
       print('Attention : risque de sur-apprentissage')

    # sous apprentissage
    # si les erreurs de test et apprentissage elevees
    if erreur_test > bruit and erreur_apprentissage > bruit:
        print('Attention : risque de sous-apprentissage')
################################
...
def main():
    ...
    #print(x_train.shape, t_train.shapex_test.shape,)

    # Entrainement du modele de regression
    regression = sr.Regression(lamb, m) #objet classe Regression
